...
/**
 * The primary key class for the invoicecreditdetail database table.
 * 
 */
@Embeddable
public class InvoicecreditdetailPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof InvoicecreditdetailPK)) {
			return false;
		}
