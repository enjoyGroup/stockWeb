...
public class SummarySaleByMonthHeader extends PdfPageEventHelper {
	
	private JSONObject 	formDataObj;
	private EnjoyItext	enjoyItext;
	
	public SummarySaleByMonthHeader(JSONObject formDataObj) {
	...
	public void onStartPage(PdfWriter writer, Document document) {
		try{
			document.add(enjoyItext.genHeader(formDataObj, "รายงานสรุปยอดขายประจำเดือน"));
			document.add(brLine());
...
//		table.addCell(enjoyItext.setCellWB("รายงานสรุปยอดขายประจำเดือน", enjoyItext.getFont10Bold(), 1, Element.ALIGN_CENTER, 0));
//		
