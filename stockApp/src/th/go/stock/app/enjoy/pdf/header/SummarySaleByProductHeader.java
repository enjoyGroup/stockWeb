...
public class SummarySaleByProductHeader extends PdfPageEventHelper {
	
	private JSONObject 	formDataObj;
	private EnjoyItext	enjoyItext;
	
	public SummarySaleByProductHeader(JSONObject formDataObj) {
	...
	public void onStartPage(PdfWriter writer, Document document) {
		try{
			document.add(enjoyItext.genHeader(formDataObj, "รายงานสรุปยอดขายตามกลุ่มสินค้า"));
			document.add(brLine());
...
//		table.addCell(enjoyItext.setCellWB("รายงานสรุปยอดขายตามกลุ่มสินค้า", enjoyItext.getFont10Bold(), 1, Element.ALIGN_CENTER, 0));
//		
