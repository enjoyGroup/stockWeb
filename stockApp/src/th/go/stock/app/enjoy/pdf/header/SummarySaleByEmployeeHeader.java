...
public class SummarySaleByEmployeeHeader extends PdfPageEventHelper {
	
	private JSONObject 	formDataObj;
	private EnjoyItext	enjoyItext;
	
	public SummarySaleByEmployeeHeader(JSONObject formDataObj) {
	...
	public void onStartPage(PdfWriter writer, Document document) {
		try{
			document.add(enjoyItext.genHeader(formDataObj, "รายงานยอดขายของพนักงาน"));
			document.add(brLine());
...
//		table.addCell(enjoyItext.setCellWB("รายงานยอดขายของพนักงาน", enjoyItext.getFont10Bold(), 1, Element.ALIGN_CENTER, 0));
//		
