...
public class SummarySaleByDayHeader extends PdfPageEventHelper {
	
	private JSONObject 	formDataObj;
	private EnjoyItext	enjoyItext;
	
	public SummarySaleByDayHeader(JSONObject formDataObj) {
	...
	public void onStartPage(PdfWriter writer, Document document) {
		try{
			document.add(enjoyItext.genHeader(formDataObj, "รายงานสรุปยอดขายประจำวัน"));
			document.add(brLine());
...
//		table.addCell(enjoyItext.setCellWB("รายงานสรุปยอดขายประจำวัน", enjoyItext.getFont10Bold(), 1, Element.ALIGN_CENTER, 0));
//		
