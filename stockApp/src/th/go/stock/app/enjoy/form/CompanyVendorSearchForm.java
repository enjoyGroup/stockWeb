...
public class CompanyVendorSearchForm {
	...
	private List<CompanyVendorBean> 	dataList;
	private HashMap						hashTable;
	
	public CompanyVendorSearchForm(){
		...
		this.totalPage				= 1;
		this.totalRecord			= "";
		this.dataList				= new ArrayList<CompanyVendorBean>();
	...
	public List<CompanyVendorBean> getDataList() {
		return dataList;
	}

	public void setDataList(List<CompanyVendorBean> dataList) {
