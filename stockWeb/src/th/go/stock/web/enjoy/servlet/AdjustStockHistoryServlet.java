...
import th.go.stock.app.enjoy.form.AdjustStockHistoryForm;
...
public class AdjustStockHistoryServlet extends EnjoyStandardSvc {
	 
	static final long serialVersionUID = 1L;
	private static final EnjoyLogger logger = EnjoyLogger.getLogger(AdjustStockHistoryServlet.class);
	
    private static final String 	FORM_NAME 				= "adjustStockHistoryForm";
    ...
    private AdjustStockHistoryForm			form						= null;
	...
	private void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		logger.info("[execute][Begin]");
 		...
 		try{
             ...
             this.form               		= (AdjustStockHistoryForm)session.getAttribute(FORM_NAME);
 			...
 			if(this.form == null || pageAction.equals("new")) this.form = new AdjustStockHistoryForm();
 			
 			if( pageAction.equals("") || pageAction.equals("new") ){
 				request.setAttribute("target", Constants.PAGE_URL +"/AdjustStockHistoryScn.jsp");
