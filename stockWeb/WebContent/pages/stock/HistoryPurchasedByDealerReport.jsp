...
<%@ page import="th.go.stock.app.enjoy.bean.HistoryPurchasedByDealerReportBean,th.go.stock.app.enjoy.bean.ComboBean"%>
<%@ page import="java.util.*"%>
<jsp:useBean id="historyPurchasedByDealerReportForm" class="th.go.stock.app.enjoy.form.HistoryPurchasedByDealerReportForm" scope="session"/>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">

<%
	HistoryPurchasedByDealerReportBean 			historyPurchasedByDealerReportBean 	= historyPurchasedByDealerReportForm.getHistoryPurchasedByDealerReportBean();
	List<HistoryPurchasedByDealerReportBean> 	dataList 							= historyPurchasedByDealerReportForm.getDataList();
	String										titlePage							= historyPurchasedByDealerReportForm.getTitlePage();
	List<ComboBean> 							companyCombo 						= historyPurchasedByDealerReportForm.getCompanyCombo();
%>
...
<body>
	<form id="frm">
		<input type="hidden" id="service" 	name="service" value="servlet.HistoryPurchasedByDealerReportServlet" />
								        		...
								        		<tr>
								        			...
								        			<td align="left">
								        				<select id="tin" name="tin" style="width: 220px;" >
								        					...
								        					<option value="<%=comboBean.getCode()%>" <%if(historyPurchasedByDealerReportBean.getTin().equals(comboBean.getCode())){ %> selected <%} %> ><%=comboBean.getDesc()%></option>
								        					<%} %>
								        				</select>
								        			</td>
								        			<td align="right">
								        			...
								        			<td align="left" colspan="3">
								        				<input type='text' 
								        					   id="vendorName" 
								        					   name='vendorName' 
								        					   value="<%=historyPurchasedByDealerReportBean.getVendorName() %>" 
								        					   maxlength="100" />
								        			</td>
								        		</tr>
								        		<tr>
								        			...
								        			<td align="left" colspan="5">
								        				<input type='text' 
								        					   ...
								        					   style="width: 100px;"
								        					   value="<%=historyPurchasedByDealerReportBean.getReciveDateFrom()%>"  />
								        				&nbsp;-&nbsp;
								        				<input type='text' 
								        					   id="reciveDateTo" 
								        					   name='reciveDateTo' 
								        					   ...
								        					   onchange="gp_checkDate(this);"
								        					   style="width: 100px;"
								        					   value="<%=historyPurchasedByDealerReportBean.getReciveDateTo()%>"  />
								        			</td>
								        		</tr>
								        		<tr>
