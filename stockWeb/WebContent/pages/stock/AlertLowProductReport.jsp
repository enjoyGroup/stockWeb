...
<%@ page import="th.go.stock.app.enjoy.bean.AlertLowProductReportBean,th.go.stock.app.enjoy.bean.ComboBean"%>
<%@ page import="java.util.*"%>
<jsp:useBean id="alertLowProductReportForm" class="th.go.stock.app.enjoy.form.AlertLowProductReportForm" scope="session"/>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">

<%
	AlertLowProductReportBean 		stockBalanceReportBean 	= alertLowProductReportForm.getAlertLowProductReportBean();
	List<AlertLowProductReportBean> dataList 				= alertLowProductReportForm.getDataList();
	String							titlePage				= alertLowProductReportForm.getTitlePage();
%>
...
<body>
	<form id="frm">
		<input type="hidden" id="service" 	name="service" value="servlet.AlertLowProductReportServlet" />
