...
<%@ page import="th.go.stock.app.enjoy.bean.InvoiceCashMasterBean,
...
<%
	String 							pageMode 				= invoiceCashMaintananceForm.getPageMode();
	InvoiceCashMasterBean 			invoiceCashMasterBean 	= invoiceCashMaintananceForm.getInvoiceCashMasterBean();
	List<ComboBean> 				invoiceStatusCombo 		= invoiceCashMaintananceForm.getInvoiceStatusCombo();
...
<head>
	...
	<script>
		...
		function lp_updateCredit(){
			try{
				confirm("คุณต้องการปรับปรุงงบการขายเงินเชื่อรายการนี้ใช่หรือไม่?", function(){
					var params 	= "pageAction=updateCredit&" + $('#frm').serialize();
					...
					$.ajax({
			            ...
			            success: function(data){
			            	...
			            	try{
			            		...
			            		alert("in lp_updateCredit :: " + e);
			            	}
			            }
			        });
				});
			}catch(e){
				alert("lp_updateCredit :: " + e);
			}
		}
...
<body onkeydown="lp_focusBarCodeTxt(event);">
	<form id="frm" onsubmit="return false;">
		<input type="hidden" id="service" 	name="service" value="servlet.InvoiceCashMaintananceServlet" />
		<input type="hidden" id="pageMode" 	name="pageMode" value="<%=pageMode%>" />
		<input type="hidden" id="seqTemp" name="seqTemp" value="<%=invoiceCashMaintananceForm.getSeqTemp()%>" />
		<input type="hidden" id="systemVat" name="systemVat" value="<%=invoiceCashMaintananceForm.VAT%>" />
		<input type="hidden" id="invoiceCredit" name="invoiceCredit" value="<%=invoiceCashMasterBean.getInvoiceCredit()%>" />
		<input type="hidden" id="updateCreditHid" name="updateCreditHid" value="<%=invoiceCashMaintananceForm.getUpdateCredit()%>" />
												...
												<tr>
								        			...
								        			<td align="left">
								        				<input type='text' 
								        					   id="invoiceCodeDis" 
								        					   name='invoiceCodeDis' 
								        					   value="<%=invoiceCashMasterBean.getInvoiceCode()%>" 
								        					   maxlength="50" 
								        					   class="input-disabled"
							        					   	   readonly="readonly"
								        					   style="width: 220px;" />
								        				<input type="hidden" id="invoiceCode" name="invoiceCode" value="<%=invoiceCashMasterBean.getInvoiceCode()%>" />
								        			</td>
								        			<td align="right">
								        			...
								        			<td align="left">
								        				...
								        				<input type='text' 
								        					   ...
								        					   value="<%=invoiceCashMasterBean.getInvoiceDate()%>" 
								        					   style="width: 100px;" />
				   										<%}else{%>
				   										<input type='text' 
								        					   id="invoiceDate" 
												...
												<tr>
								        			...
								        			<td align="left" colspan="3">
								        				<input type='text' 
								        					   ...
								        					   value="<%=invoiceCashMasterBean.getSaleCommission() %>" 
								        					   style="width: 220px;" />
								        			</td>
									        	</tr>
								        		<tr>
								        			...
								        			<td align="left" valign="middle">
								        				<span>
									        				<input  type="radio" 
																	...
																	<%if(invoiceCashMasterBean.getInvoiceType().equals("V")){%> checked="checked" <%} %> 
															/>
															มี VAT
														</span>
														<span style="margin-left: 5px;">
															<input  type="radio" 
																	...
																	value="N" 
																	onclick="lp_calInvoiceVat();"
																	<%if(invoiceCashMasterBean.getInvoiceType().equals("N")){%> checked="checked" <%} %> 
															/>
															ไม่มี VAT
														</span>
								        			</td>
												...
												<tr>
									        		<td align="right">
														...
														<input type='text' 
								        					   ...
								        					   name='invoicePrice' 
								        					   class="moneyOnly"
								        					   value="<%=invoiceCashMasterBean.getInvoicePrice()%>" 
								        					   maxlength="50" 
								        		...
								        		<tr>
									        		<td align="right">
														...
														<input type='text' 
								        					   ...
								        					   class="moneyOnly"
								        					   value="<%=invoiceCashMasterBean.getInvoicediscount()%>" 
								        					   maxlength="50" 
								        					   onblur="gp_checkAmtOnly(this, 12);lp_calInvoiceVat();"
								        					   style="width: 220px;" />
								        				<span>&nbsp;บาท</span>
								        		...
								        		<tr>
									        		<td align="right">
														...
														<input type='text' 
								        					   ...
								        					   name='invoiceVat' 
								        					   class="moneyOnly"
								        					   value="<%=invoiceCashMasterBean.getInvoiceVat()%>" 
								        					   maxlength="50" 
								        		...
								        		<tr>
									        		<td align="right">
														...
														<input type='text' 
								        					   ...
								        					   name='invoiceDeposit' 
								        					   class="moneyOnly"
								        					   value="<%=invoiceCashMasterBean.getInvoiceDeposit()%>" 
								        					   maxlength="50" 
								        					   onblur="gp_checkAmtOnly(this, 12);lp_InvoiceTotal();"
								        					   style="width: 220px;" />
								        				<span>&nbsp;บาท</span>
								        		...
								        		<tr>
									        		<td align="right">
														...
														<input type='text' 
								        					   ...
								        					   name='invoiceTotal' 
								        					   class="moneyOnly"
								        					   value="<%=invoiceCashMasterBean.getInvoiceTotal()%>" 
								        					   maxlength="50" 
								        					   onblur="gp_checkAmtOnly(this, 12);"
								        					   style="width: 220px;" />
								        				<span>&nbsp;บาท</span>
								        				...
								        				<input type="button" id="btnSave" class="btn btn-sm btn-warning" value='บันทึก' onclick="lp_save();" />&nbsp;&nbsp;&nbsp;
				   										...
				   										<%}else{%>
				   											<%if(invoiceCashMaintananceForm.getUpdateCredit().equals("Y")){ %>
				   												<input type="button" id="btnUpdateCredit" name="btnUpdateCredit" class="btn btn-sm btn-warning" value='ปรับปรุงสถานะ' onclick="lp_updateCredit();" />
				   											<%}else{ %>
				   												<%if(!invoiceCashMasterBean.getInvoiceStatus().equals("C")){ %>
